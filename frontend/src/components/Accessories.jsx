...
import access1 from '../assets/accessories1.png'
import access2 from '../assets/accessories2.png'
import access3 from '../assets/accessories3.png'
import access4 from '../assets/accessories4.png'
            ...
            <div className={styles.laptops}>
                <div className={styles.container}>
                    <div className={styles.path}>
                        <p>Home/Products<span>/Accessories</span></p>
                    ...
                    <div className={styles.cards}>
                        <div className={styles.card}>
                            <div>
                                <img src={access1} alt="" />
                                <p className={styles.discription}>Pc Power PCM 101G RGB Wired Gaming Mouse</p>
                                <div className={styles.buy}>
                                    <p className={styles.buynow}>BUY NOW</p>
                                    <p className={styles.price}>5 500,00 DA</p>
                                </div>
                            </div>
                        </div>
                        <div className={styles.card}>
                            <div>
                                <img src={access2} alt="" />
                                <p className={styles.discription}>Compact 60% RGB Backlit Gaming Keyboard</p>
                                <div className={styles.buy}>
                                    <p className={styles.buynow}>BUY NOW</p>
                                    <p className={styles.price}>12 000,00 DA</p>
                                </div>
                            </div>
                        </div>
                        <div className={styles.card}>
                            <div>
                                <img src={access3} alt="" />
                                <p className={styles.discription}>JBL Quantum Duo | PC Gaming Speakers</p>
                                <div className={styles.buy}>
                                    <p className={styles.buynow}>BUY NOW</p>
                                    <p className={styles.price}>18 500,00 DA</p>
                                </div>
                            </div>
                        </div>
                        <div className={styles.card}>
                            <div>
                                <img src={access4} alt="" />
                                <p className={styles.discription}>PC One Piece Mouse Luffy</p>
                                <div className={styles.buy}>
                                    <p className={styles.buynow}>BUY NOW</p>
