...
import powersuplie1 from '../assets/powersuplies1.png'
import powersuplie2 from '../assets/powersuplies2.png'
import powersuplie3 from '../assets/powersuplies3.png'
import headset4 from '../assets/headset4.png'

function Powersuplies() {
    return (
        <div>
            {/* start header  */}
            ...
            <div className={styles.laptops}>
                <div className={styles.container}>
                    <div className={styles.path}>
                        <p>Home/Products<span>/Powersuplies</span></p>
                    ...
                    <div className={styles.cards}>
                        <div className={styles.card}>
                            <div>
                                <img src={powersuplie1} alt="" />
                                <p className={styles.discription}>1050W Power Supply RGB Fully Modular</p>
                                <div className={styles.buy}>
                                    <p className={styles.buynow}>BUY NOW</p>
                                    <p className={styles.price}>22 900,00 DA</p>
                                </div>
                            </div>
                        </div>
                        <div className={styles.card}>
                            <div>
                                <img src={powersuplie2} alt="" />
                                <p className={styles.discription}>Seasonic 300W PC Power Supply</p>
                                <div className={styles.buy}>
                                    <p className={styles.buynow}>BUY NOW</p>
                                    <p className={styles.price}>5000,00 DA</p>
                                </div>
                            </div>
                        </div>
                        <div className={styles.card}>
                            <div>
                                <img src={powersuplie3} alt="" />
                                <p className={styles.discription}>XP Power Switching Power Supply</p>
                                <div className={styles.buy}>
                                    <p className={styles.buynow}>BUY NOW</p>
                                    <p className={styles.price}>63 500 DA</p>
                                </div>
                            </div>
                        </div>
                        <div className={styles.card}>
