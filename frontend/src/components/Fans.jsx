...
import fans1 from '../assets/fans1.png'
import fans2 from '../assets/fans2.png'
import fans3 from '../assets/fans3.png'
            ...
            <div className={styles.laptops}>
                <div className={styles.container}>
                    <div className={styles.path}>
                        <p>Home/Products<span>/Fans</span></p>
                    ...
                    <div className={styles.cards}>
                        <div className={styles.card}>
                            <div>
                                <img src={fans1} alt="" />
                                <p className={styles.discription}>120x25mm Computer Case Fan with PWM</p>
                                <div className={styles.buy}>
                                    <p className={styles.buynow}>BUY NOW</p>
                                    <p className={styles.price}>1500,00 DA</p>
                                </div>
                            </div>
                        </div>
                        <div className={styles.card}>
                            <div>
                                <img src={fans2} alt="" />
                                <p className={styles.discription}>ALSEYE 120mm RGB PC Case Fan</p>
                                <div className={styles.buy}>
                                    <p className={styles.buynow}>BUY NOW</p>
                        ...
                        <div className={styles.card}>
                            <div>
                                <img src={fans3} alt="" />
                                <p className={styles.discription}>CT140 PC Cooling Fan (2-Fan Pack)</p>
                                <div className={styles.buy}>
                                    <p className={styles.buynow}>BUY NOW</p>
                                    <p className={styles.price}>6 000,00 DA</p>
                                </div>
                            </div>
                        </div>
                    </div>
